...
<sub>02 · Materials animated mechanics diagram · b-cell b-codec-mechanics cell-5 row-2</sub>
<figure>
        <div><img src="docs/assets/product-page-mechanics.gif" alt="Materials approved scientific square mechanics diagram showing candidate screening-matrix mechanics."></div>
...
<div><b>02 · MARKETS</b><span>WORKFLOW FIT</span></div>
      <div>
        <div>
          <div><span>Battery R&amp;D groups</span><span></span><span>fit</span></div>
          <div><span>Materials informatics teams</span><span></span><span>primary</span></div>
          <div><span>Thermoelectric R&amp;D groups</span><span></span><span>fit</span></div>
          <div><span>Industrial AI / MLIP teams</span><span></span><span>fit</span></div>
          <div><span>DFT / solver groups</span><span></span><span>adjacent</span></div>
        </div>
      </div>
...
<div><b>05.2 · BENCHMARKS</b><span>POST-WAVE-F &middot; CPU + RUNPOD-SIM</span></div>
      <div>
        ...
        <div>
          <div><span>CPU strict</span><span></span><span>3,547/3,547</span></div>
          <div><span>Runpod parity</span><span></span><span>588/588</span></div>
          <div><span>H100 evidence</span><span></span><span>pending</span></div>
        </div>
      </div>
...
<div><b>06.1 · COMPARATIVE PERFORMANCE &middot; CPU WORKBENCH VS GPU CAMPAIGN</b></div>
      <div>
        <div>
          <div><span>CPU strict-full</span><span></span><span>3,547 / 3,547 PASS</span></div>
          <div><span>Runpod parity</span><span></span><span>588 / 588 PASS</span></div>
          <div><span>H100 real artifact</span><span></span><span>campaign pending</span></div>
          <div><span>DFT/MLIP comparator</span><span></span><span>not yet measured</span></div>
        </div>
      </div>
