...
:meth:`zer0pa_materials_workbench.audit.log.AuditLog.append_event` so they're chained
...
def is_reasoner_tuple_exportable(
    ...
    * open_science tuples → may be exported anywhere.
    ...
    :func:`zer0pa_materials_workbench.audit.rights.is_reuse_scope_compatible`.
    """
