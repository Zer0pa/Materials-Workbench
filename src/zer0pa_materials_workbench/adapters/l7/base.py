...
Every L7 adapter emits :class:`zer0pa_materials_workbench.envelope.Envelope` with
``layer="L7"`` and ``output`` validated against
:class:`zer0pa_materials_workbench.envelope.L7CampaignOutput`.

Boundary discipline:

* The boundary block is baked in via :data:`zer0pa_materials_workbench.boundary.RESEARCH_BOUNDARY`.
