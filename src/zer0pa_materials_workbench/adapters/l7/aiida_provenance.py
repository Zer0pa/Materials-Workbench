...
:class:`~zer0pa_materials_workbench.audit.kg.KGNodeType.Hypothesis` or
:class:`~zer0pa_materials_workbench.audit.kg.KGNodeType.OPTIMADEResource` source.
"""
...
__all__ = ["AiiDAProvenanceAdapter", "ProvenanceGraph", "ProvenanceTriple"]
