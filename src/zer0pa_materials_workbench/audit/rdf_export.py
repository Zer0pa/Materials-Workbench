...
Walks every node/edge in :class:`zer0pa_materials_workbench.audit.kg.MaterialsKG` and
...
* EMMO IRIs (or Zer0pa-extension IRIs) per the mapping in
  :mod:`zer0pa_materials_workbench.ontology.emmo`.
...
from zer0pa_materials_workbench.audit.kg import KGEdge, KGNode, MaterialsKG
