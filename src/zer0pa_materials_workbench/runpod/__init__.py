...
Public surface
--------------
* :mod:`~zer0pa_materials_workbench.runpod.mock_backends`  — per-layer runpod_mock backends.
* :mod:`~zer0pa_materials_workbench.runpod.cutover`        — cutover orchestrator.
* :mod:`~zer0pa_materials_workbench.runpod.hard_failures`  — 10 PRD-mandated detectors.
* :mod:`~zer0pa_materials_workbench.runpod.rest_client`    — Wave C live REST client.
* :mod:`~zer0pa_materials_workbench.runpod.dispatcher`     — Wave C honest-block dispatch.
