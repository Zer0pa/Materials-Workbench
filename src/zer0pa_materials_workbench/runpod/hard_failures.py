...
3. If ``passed is False``, emits a :class:`~zer0pa_materials_workbench.envelope.FalsifierItem`
...
class HardFailureDetector:
    ...
    def detect_missing_boundary_block(
        ...
        return HardFailureResult(
            ...
            suggested_fix=(
                "Set research_boundary = zer0pa_materials_workbench.boundary.RESEARCH_BOUNDARY "
