...
* uses :class:`zer0pa_materials_workbench.envelope.Envelope` (so the boundary block
...
e.g. :func:`zer0pa_materials_workbench.adapters.ionic.base.make_ionic_envelope`).
"""
