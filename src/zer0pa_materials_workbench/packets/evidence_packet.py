...
Per ``zer0pa_materials_workbench.boundary.RESEARCH_BOUNDARY``, every artifact this
...
class EvidencePacket(BaseModel):
    ...
    Constructed by :func:`zer0pa_materials_workbench.packets.assemble_battery_packet`
    or :func:`zer0pa_materials_workbench.packets.assemble_thermoelectric_packet` and
    consumed by:

    * :func:`zer0pa_materials_workbench.packets.validate_evidence_packet`
    * :func:`zer0pa_materials_workbench.packets.export_packet_to_ro_crate`
    ...
    def _v_boundary(cls, v: str) -> str:
        if v != RESEARCH_BOUNDARY:
            raise ValueError(
                ...
                "See zer0pa_materials_workbench.boundary.RESEARCH_BOUNDARY."
            )
        return v
