...
:class:`zer0pa_materials.runpod.dispatcher.RunpodDispatcher` which decides
...
# with :data:`zer0pa_materials.runpod.mock_backends.RUNPOD_MOCK_LAYERS`.
Layer = Literal[
    "L1",
    "L2",
    "ionic",
...
class RunpodCredentialsError(RuntimeError):
    ...
    :class:`zer0pa_materials.audit.BlockedSourceManifest`.  This is the
...
class RunpodRestClient:
    ...
    def healthz(self, layer: Layer) -> bool:
        ...
        Used by :meth:`zer0pa_materials.runpod.cutover.RunpodCutover.precheck`
