...
def assemble_battery(
    ...
    candidate_id: Annotated[Optional[str], typer.Option(help="Override candidate URN")] = None,
    campaign_id: Annotated[Optional[str], typer.Option(help="Override campaign URN")] = None,
    out_path: Annotated[
        Optional[str], typer.Option(help="If set, write packet JSON to this file.")
    ] = None,
) -> None:
