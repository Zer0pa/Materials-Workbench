...
from zer0pa_materials.services.l7_service import BLOCKED_SOURCES
...
def create_campaign(
    ...
    audit_dir: Annotated[Optional[str], typer.Option(help="Override audit dir.")] = None,
    kg_path: Annotated[Optional[str], typer.Option(help="Override KG sqlite path.")] = None,
) -> None:
...
def dispatch(
    ...
    audit_dir: Annotated[Optional[str], typer.Option()] = None,
    kg_path: Annotated[Optional[str], typer.Option()] = None,
) -> None:
