...
(:mod:`zer0pa_materials.packets.evidence_packet`). Per-objective generators
live in :mod:`zer0pa_materials.packets.battery_packet` and
:mod:`zer0pa_materials.packets.thermoelectric_packet`. The RO-Crate
exporter in :mod:`zer0pa_materials.packets.ro_crate_export` round-trips
serialise → parse → counts-match without loss; the validator suite in
:mod:`zer0pa_materials.packets.validators` enforces the PRD §Audit Trail
...
from zer0pa_materials.packets.battery_packet import (
    BatteryPacketAssembler,
    assemble_battery_packet,
)
from zer0pa_materials.packets.thermoelectric_packet import (
    ThermoelectricPacketAssembler,
    assemble_thermoelectric_packet,
)
from zer0pa_materials.packets.ro_crate_export import (
    PacketRoCrateBundle,
    export_packet_to_ro_crate,
    parse_packet_ro_crate,
)
from zer0pa_materials.packets.validators import (
    ValidationReport,
