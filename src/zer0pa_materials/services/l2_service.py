...
The service is started with uvicorn:
    uvicorn zer0pa_materials.services.l2_service:app --port 8042
"""
    ...
    def finetune(body: L2FinetuneRequestPayload) -> dict[str, Any]:  # type: ignore[name-defined]
        ...
        return {
            ...
            "note": (
                ...
                f"100–500 DFT configs + 1–4 GPU-h on A100. "
                f"Set L2_BACKEND=runpod_rest to enable real fine-tuning."
            ),
