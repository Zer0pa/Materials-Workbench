...
The service is started with uvicorn:
    uvicorn zer0pa_materials.services.l3_service:app --port 8043
...
def _make_app() -> "FastAPI":  # type: ignore[return]
    ...
    def healthz() -> dict[str, Any]:
        from zer0pa_materials.adapters.l3.espei_fit import ESPEI_AVAILABLE
        from zer0pa_materials.adapters.l3.pycalphad_equilibrium import PYCALPHAD_AVAILABLE
