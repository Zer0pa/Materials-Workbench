...
items (via :mod:`zer0pa_materials.packets.validators`) and as
standalone falsifiers exposed under
:mod:`zer0pa_materials.falsifiers` for the falsification-wave runner.
...
def packet_boundary_carriage(packet: "EvidencePacket") -> FalsifierItem:
    ...
    :class:`zer0pa_materials.boundary.BoundaryError` on a missing block;
