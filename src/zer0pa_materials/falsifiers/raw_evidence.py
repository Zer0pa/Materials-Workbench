...
def recompute_l2_disagreement(
    ...
    :class:`zer0pa_materials.adapters.l2.ensemble.L2EnsembleRunner.run`:
...
def recompute_structure_hash_from_envelope(
    ...
    :func:`zer0pa_materials.envelope.hashing.structure_hash`. A claim
...
def iter_audit_rows(
    ...
    * a ``zer0pa_materials.audit.log.AuditLog`` instance (calls
