...
Status: historical rename prompt. The live repository is now `https://github.com/Zer0pa/Materials-Workbench`.
...
- Do not keep compatibility shims for the old import package or old console command.
